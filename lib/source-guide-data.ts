...
export const SOURCE_GUIDES: SourceGuide[] = [
  ...
  {
    id: 'autumn-coast-festival',
    category: '關卡活動',
    title: '金秋海岸狂歡：先拿魚餌，積分停損待核對',
    updated: '2026/09/22',
    status: '現行',
    summary: '官方蘋果商店已顯示活動卡：完成任務取得魚餌、解鎖釣魚圖鑑，釣魚積分可用來兌換獎勵。官方卡片未列積分門檻、魚餌總量或截止時間，本站暫不提供固定開箱量與補鑽結論。',
    actions: ['先完成遊戲內免費任務並領取魚餌', '在遊戲內核對釣魚圖鑑、積分商店與活動倒數', '確認目標獎勵與所需積分後，再用活動試算判斷是否補資源'],
    sourceUrl: 'https://apps.apple.com/tw/app/survivor-io/id1528941310?eventid=6806954050',
  },
  {
    ...
    updated: '2026/09/17',
    status: '需版本核對',
    summary: '「別說筆記」記錄的本期活動已於 9 月 21 日結束；五千二百五十積分與重置玩法僅供日後復刻時重新核對，不能當成現行活動。五百八十五張任務票包含開到六百個寶箱，並非完全免費。',
    actions: ['復刻時先核對獎勵表與重置成本', '原期以五千二百五十積分為停損', '不要直接沿用原期的免費票總量與開箱需求'],

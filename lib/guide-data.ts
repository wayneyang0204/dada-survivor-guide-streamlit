...
export const OFFICIAL_UPDATE = {
  version: '5.1.0',
  checkedAt: '2026-09-10 09:05',
  headline: '水上樂園大亂鬥已上架',
  summary:
    '官方活動頁確認可使用水槍參加，獎勵可能包含轉化核心、限定收藏品與幽冥烈焰追獵者碎片；完整時間、任務數與里程碑仍待核對。',
  bullets: [
    '先領免費水槍；獎勵表與成本未核實前，不先投入大量寶石或鑰匙',
    '煲湯廚房已於 9 月 9 日結束，只保留作復刻機制參考',
  ...
  sources: [
    {
      name: '水上樂園大亂鬥｜官方活動頁',
      url: 'https://apps.apple.com/us/app/survivor-io/id1528941310?eventid=6806949373',
    },
    {
      name: '安卓商店｜官方',

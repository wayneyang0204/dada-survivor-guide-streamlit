...
export const OFFICIAL_UPDATE = {
  version: '5.2.0',
  checkedAt: '2026-09-11 09:05',
  headline: '5.2.0 已開始分批上架',
  summary:
    '官方商店已公布 5.2.0：新增 346–350 章、神火特工洛基與高階特工伊蓮；台灣蘋果商店目前仍顯示 5.1.0，請以自己商店可下載版本為準。',
  bullets: [
    '新增主線 346–350 章與對應挑戰章節',
    '神火特工洛基與高階特工伊蓮已列入更新；技能、覺醒與終局排名仍待可靠實測',
    '特工同調等級 100、公會活動「潮霧港灣」仍標示為即將推出',
    '新增雲端高塔、秋日海底探索等活動；名稱為本站暫譯，實際名稱以繁中遊戲內為準',
  ],
  sources: [
    {

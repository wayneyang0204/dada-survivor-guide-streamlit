...
export const COLLECTION_SET_GUIDE = [
  {
    title: '自選箱先補星際躍遷矩陣圖紙',
    label: '缺件就換它',
    detail: '點到紅3就停。這件同時養無人機與暴擊率，比開空欄位或追其他傳奇划算。',
  },
  {
    title: '接著把水動推力腳蹼點到紅3',
    label: '史詩先紅3',
    detail: '成本比傳奇低，一樣補無人機與暴擊。圖紙紅3之後立刻點它，不要分去升別的史詩。',
  },
  {
    title: '第三件才是暗物質傀儡黃5',
    label: '雙生無人機',
    detail: '前兩件紅3之後才點。黃5以前不要追紅星，也不要先把收藏之心拿去開空欄位。',
  },
  {
    title: '追光者與混亂之劍先不要',
    label: '現在不要升',
    detail: '終局主武器已經是雙生槍。這兩件只在你還用舊武器時才值得追滿。',
  },
] as const;

...
def classify_article(title: str, excerpt: str = "") -> str:
    ...
    if "區域行動" in title:
        return "關卡模式"
    rules = [
        ("活動攻略", ("活動", "慶典", "派對", "扭蛋", "拼圖", "探寶", "尋寶", "格子舖", "礦場", "彩虹礦", "彩虹棋", "彩虹骰", "一番賞", "訂單員", "轉盤", "圓盤", "麥克風", "大亂鬥", "水槍")),
...
EVENT_PLAYBOOKS = [
    {
        ...
        "verdict": "以三百三十累計水槍的神器核心自選箱為停損；前四天先開二百至二百五十箱，最後一天才依差額調整。",
        "period": "社群整理：9/11 00:00－9/15 23:59（以遊戲內倒數為準）",
        "tags": ["社群5.2.0試算", "三百三十停損", "神器核心", "水槍返還", "開箱成本"],
        "highlights": [

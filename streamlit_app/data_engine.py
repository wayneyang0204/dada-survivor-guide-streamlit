...
def classify_article(title: str, excerpt: str = "") -> str:
    ...
    if "區域行動" in title:
        return "關卡模式"
    rules = [
        ("活動攻略", ("活動", "慶典", "派對", "扭蛋", "拼圖", "探寶", "尋寶", "格子舖", "礦場", "彩虹礦", "彩虹棋", "彩虹骰", "一番賞", "訂單員", "轉盤", "圓盤", "麥克風", "大亂鬥", "水槍", "鉛筆", "橡皮")),
...
EVENT_PLAYBOOKS = [
    {
        ...
        "verdict": "以五千二百五十積分的諧振晶片與傳奇收藏品自選箱為停損；不追六千六百解構機，也不為每日排名買票。",
        "period": "社群整理：9/17 00:00－9/21 23:59（以遊戲內倒數為準）",
        "tags": ["社群5.2.0攻略", "五千二百五十停損", "立即重置", "開箱成本", "不追排名"],
        "highlights": [

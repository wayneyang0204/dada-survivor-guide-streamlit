...
攻略資料 = [
    {
        ...
        "日期": "2026/09/11",
        "狀態": "官方已上架｜台灣 5.2.0",
        "摘要": "台灣與美國官方蘋果商店目前皆已上架 5.2.0，新增 346～350 章、神火特工洛基與高階特工伊蓮；特工同調等級 100 與公會活動「潮霧港灣」仍是預告內容。兩名新特工的技能、覺醒與終局排名尚待可靠實測。",
        "行動": ["挑戰 346～350 章前先把遊戲更新到 5.2.0", "完整數值公開前，不先轉換主力或投入萬能碎片", "新主線先沿用已成形後期配置，卡關再依實際詞條調整"],
    ...
    },
    {
        ...
        "日期": "2026/09/11",
        "狀態": "社群試算｜5.2.0 現行",
        "摘要": "「別說筆記」社群試算把三百三十累計水槍列為神器核心停損點。三百一十八至三百二十二把是完成全部任務的總量，包含開寶箱任務，不能當成完全免費；隨機返還約三至五成也只是估算。",
        "行動": ["前四天先開二百至二百五十箱，最後一天依差額調整", "累計消耗三百三十水槍拿到神器核心後停手", "不追六百三十檔；即使開六百箱仍可能需要大量寶石"],
...
官方版本資訊 = {
    ...
    "重點": ["新增主線 346～350 章與對應挑戰章節", "新增神火特工洛基與高階特工伊蓮，終局排名待實測", "特工同調等級 100 與公會活動潮霧港灣仍是預告", "新增雲端高塔與秋日海底探索等活動", "台灣官方蘋果商店目前已上架 5.2.0"],
}
...
if 頁面 == "攻略首頁":
    ...
    官方活動文章 = {
        "title": "水上樂園大亂鬥",
        "date": "2026/09/11",
        "excerpt": "官方已確認可使用水槍參加；社群完整試算暫時無法取得時，請以遊戲內獎勵表為準。",
    ...
    if not any("水上樂園大亂鬥" in item["title"] for item in 活動文章):
        活動文章.insert(0, 官方活動文章)
    if 活動文章:
        預設活動索引 = next(

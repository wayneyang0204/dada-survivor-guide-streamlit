...
攻略資料 = [
    {
        ...
        "日期": "2026/09/10",
        "狀態": "官方活動｜資料待補",
        "摘要": "官方目前只確認可用水槍參加，並有機會取得轉化核心、限定收藏品與幽冥烈焰追獵者碎片。完整任務數、機率與里程碑尚未核實。",
        "行動": ["先領登入、任務與免費水槍", "進遊戲核對結束時間、獎勵表與水槍取得量", "可靠數值補齊前只做免費進度，不預先投入寶石或鑰匙"],
        "來源": "https://apps.apple.com/us/app/survivor-io/id1528941310?eventid=6806949373",
    },
    {
        "分類": "關卡活動",
...
官方版本資訊 = {
    "版本": "5.1.0",
    "查核": "2026/09/10",
    "標題": "水上樂園大亂鬥與主線 341～345 章",
    "重點": ["可使用水槍參加水上樂園大亂鬥", "獎勵可能包含轉化核心、限定收藏品與幽冥烈焰追獵者碎片", "完整時間、任務數與里程碑仍待核對", "煲湯廚房已於 9 月 9 日結束", "足球模式共鳴超載預告"],
}
...
if 頁面 == "攻略首頁":
    ...
    官方活動文章 = {
        ...
        "link": "https://apps.apple.com/us/app/survivor-io/id1528941310?eventid=6806949373",
        "category": "活動攻略",

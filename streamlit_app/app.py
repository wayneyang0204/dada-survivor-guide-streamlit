...
攻略資料 = [
    {
        ...
        "日期": "2026/09/05",
        "狀態": "現行｜9/9 最後一天",
        "摘要": "官方活動頁確認單鍋不可超過二十四點；社群攻略估算完整任務可取得三百至三百二十二張湯勺。無課與鑰匙有限者先以二百二十湯勺的異世寵物自選箱為目標。",
...
官方版本資訊 = {
    "版本": "5.1.0",
    "查核": "2026/09/09",
    "標題": "煲湯廚房與主線 341～345 章",
    "重點": ["煲湯廚房於 9 月 5 日至 9 日開放", "單鍋不要超過二十四點", "積分可兌換稀有獎勵並有機會取得核心寶箱", "足球模式共鳴超載預告"],
}

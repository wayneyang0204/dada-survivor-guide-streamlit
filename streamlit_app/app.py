...
攻略資料 = [
    {
        "分類": "最新系統",
        "標題": "5.2.0：洛基、伊狑與主線 350 章更新判斷",
        "日期": "2026/09/18",
        "狀態": "官方已上架｜台灣 5.2.0",
        "摘要": "台灣與美國官方蘋果商店目前皆已上架 5.2.0，新增 346～350 章、神火特工洛基與高階特工伊狑；特工同調等級 100 與公會活動「潮汐祕境」仍是預告內容。官方確認洛基已上線，實戰配置採用 9 月 17 日玩家測試，伊狑仍待可靠實測。",
        "行動": ["挑戰 346～350 章前先把遊戲更新到 5.2.0", "洛基先依哪吒覺醒與寶石存量判斷，不直接取代主位", "伊狑完整數值公開前，不先轉換主力或投入萬能碎片"],
        "來源": "https://apps.apple.com/us/app/survivor-io/id1528941310",
    },
    {
        "分類": "特工寵物",
        "標題": "洛基實測：哪吒覺醒6後才值得補完整神火鏈",
        "日期": "2026/09/17",
        "狀態": "玩家實測｜5.2.0 現行",
    ...
    {
        "分類": "關卡活動",
        "標題": "金秋海岸狂歡：先拿魚餌，積分停損待核對",
        "日期": "2026/09/22",
        "狀態": "官方活動卡｜5.2.0 現行",
        "摘要": "官方蘋果商店已顯示活動卡：完成任務取得魚餌、解鎖釣魚圖鑑，釣魚積分可兌換獎勵。官方卡片未列積分門檻、魚餌總量或截止時間，暫不提供固定開箱量與補鑽結論。",
        "行動": ["先完成遊戲內免費任務並領取魚餌", "在遊戲內核對釣魚圖鑑、積分商店與活動倒數", "確認目標獎勵與所需積分後，再用活動試算判斷是否補資源"],
        "來源": "https://apps.apple.com/tw/app/survivor-io/id1528941310?eventid=6806954050",
    },
    {
        "分類": "關卡活動",
        "標題": "鉛筆王國秘寶：五千二百五十積分停損",
        "日期": "2026/09/17",
        "狀態": "歷史活動｜已於9/21結束",
        "摘要": "「別說筆記」記錄的本期活動已於 9 月 21 日結束；五千二百五十積分與重置玩法僅供復刻時重新核對。五百八十五張任務票包含開到六百個寶箱，並非完全免費。",
        "行動": ["復刻時先核對獎勵表與重置成本", "原期以五千二百五十積分為停損", "不要直接沿用原期的免費票總量與開箱需求"],
        "來源": "https://notalknote.xyz/survivorio-pencil-kingdom-treasure-guide/",
    },
    {
        "分類": "關卡活動",
        "標題": "水上樂園大亂鬥：三百三十水槍拿神器核心",
        "日期": "2026/09/11",
        "狀態": "歷史活動｜已於9/15結束",
        "摘要": "本期已於 9 月 15 日結束。保留三百三十累計水槍與開箱成本，只供復刻時重新核對，不能直接當成現行活動。",
        "行動": ["復刻時先核對獎勵表與水槍返還率", "原期停損為累計消耗三百三十水槍", "不直接沿用原期的免費量與寶石缺口"],
        "來源": "https://notalknote.xyz/survivorio-water-park-brawl-guide/",
    },
    {
        "分類": "關卡活動",
    ...
    {
        "分類": "載具養成",
        "標題": "載具與模組：先解鎖全種類，再集中主戰載具",
        "日期": "2026/09/11",
        "狀態": "現行",
        "摘要": "通過第八十章後開啟載具；只能啟用一台主戰載具，備用載具按同步率傳遞模組單件屬性，整排技能只對主戰載具生效。",
        "行動": ["先解鎖平衡車與懸浮滑板，再以幻影追獵者作主戰，末日戰馬最後", "先增加載具種類與模組槽位，再集中升星", "金色模組優先技能、首領與護盾增傷，並優先留方形模組"],
        "來源": "https://notalknote.xyz/survivorio-vehicle-and-unit-guide/",
    },
    {
        "分類": "裝備養成",
        "標題": "星鑄腰帶與扭曲腰帶：何時更換",
        ...
        return [
            {
                "標題": "神火特攻第三彈：洛基實測攻略",
                "日期": "2026/09/17",
                "網址": "https://notalknote.xyz/survivorio-divine-fire-3-sp-loki-guide/",
            },
            {
                "標題": "鉛筆王國秘寶攻略",
                "日期": "2026/09/17",
                "網址": "https://notalknote.xyz/survivorio-pencil-kingdom-treasure-guide/",
            },
            {
                "標題": "洛基特工完整攻略",
                "日期": "2026/09/15",
                "網址": "https://notalknote.xyz/loki/",
            },
            {
                "標題": "水上樂園大亂鬥攻略",
                "日期": "2026/09/11",
                "網址": "https://notalknote.xyz/survivorio-water-park-brawl-guide/",
            },
            {
                "標題": "載具與模組完整攻略",
                "日期": "2026/09/11",
                "網址": "https://notalknote.xyz/survivorio-vehicle-and-unit-guide/",
            },
            {
                "標題": "煲湯廚房攻略",
                "日期": "2026/09/05",
...
官方版本資訊 = {
    ...
    "重點": ["新增主線 346～350 章與對應挑戰章節", "官方確認神火特工洛基與高階特工伊狑已上線", "洛基實戰判斷採用 9 月 17 日玩家測試，伊狑終局排名待實測", "特工同調等級 100 與公會活動潮汐祕境仍是預告", "官方活動卡新增金秋海岸狂歡；先完成任務拿魚餌，積分門檻以遊戲內為準"],
}
...
if 頁面 == "攻略首頁":
    ...
    活動備援文章 = {
        "title": "金秋海岸狂歡",
        "date": "2026/09/22",
        "excerpt": "官方活動卡確認任務可取得魚餌、釣魚積分可兌換獎勵；具體門檻與截止時間請核對遊戲內。",
        "link": "https://apps.apple.com/tw/app/survivor-io/id1528941310?eventid=6806954050",
        "category": "活動攻略",
        "freshness": "官方現行活動｜來源備援",
    }
    活動文章 = [item for item in 全部文章 if item["category"] == "活動攻略"]
    if not any("金秋海岸狂歡" in item["title"] for item in 活動文章):
        活動文章.insert(0, 活動備援文章)
    if 活動文章:
        預設活動索引 = next(
    ...
    with 精選頁:
        ...
        with c2:
            分類 = st.selectbox("精選分類", ["全部", "最新系統", "科技配件", "收藏系統", "特工寵物", "載具養成", "裝備養成", "關卡活動"], key="curated_category")

...
攻略資料 = [
    ...
    },
    {
        ...
        "日期": "2026/09/17",
        "狀態": "社群攻略｜5.2.0 現行",
        "摘要": "任何頂部獎勵被推出後就立刻重置，把每次行動維持在一張票。所謂五百八十五張任務票包含開到六百個寶箱，不能算成完全免費。",
        "行動": ["下排放補給箱、配件與收藏品鑰匙；上排放史詩配件或傳奇收藏品碎片", "前四天先開二百至二百六十箱，最後一天依進度補到約三百至三百六十箱", "五千二百五十積分拿完諧振晶片與傳奇收藏品自選箱就停，不追六千六百與每日排名"],
...
官方版本資訊 = {
    ...
    "重點": ["新增主線 346～350 章與對應挑戰章節", "官方確認神火特工洛基與高階特工伊狑已上線", "洛基實戰判斷採用 9 月 17 日玩家測試，伊狑終局排名待實測", "特工同調等級 100 與公會活動潮汐祕境仍是預告", "新增雲中塔與秋日海底探險等活動"],
}
...
if 頁面 == "攻略首頁":
    ...
    活動備援文章 = {
        "title": "鉛筆王國秘寶",
        "date": "2026/09/17",
        "excerpt": "社群 5.2.0 攻略把五千二百五十積分列為停損；活動時間與獎勵仍以遊戲內倒數為準。",
        "link": "https://notalknote.xyz/survivorio-pencil-kingdom-treasure-guide/",
        "category": "活動攻略",
        "freshness": "社群現行攻略｜來源備援",
    }
    活動文章 = [item for item in 全部文章 if item["category"] == "活動攻略"]
    if not any("鉛筆王國秘寶" in item["title"] for item in 活動文章):
